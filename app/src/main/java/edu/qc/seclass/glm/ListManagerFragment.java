...
public class ListManagerFragment extends Fragment {
     ...
     * From my understanding, the returned inflater populates the layout (fragment_list_manager) with
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_list_manager,container,false);
    }
}
